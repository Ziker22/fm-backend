def get_place_review_prompt(name: str, city: str, types: list[str] = []) -> str:
    ...
    - description: 3 paragraph description in Slovak language (3-5 sentences with at least one mentioning why is it good for kids).
        - DO NOT include any links sources and webpages within the description
