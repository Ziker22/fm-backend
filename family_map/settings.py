"""
Django settings for family_map project.
...
SECRET_KEY = 'django-insecure-3ri-*f(@i0k6rh)+wzgz97!3*2o2%-9=7c-%$6a@n3m@kxoj+y'
...
WSGI_APPLICATION = 'family_map.wsgi.application'
